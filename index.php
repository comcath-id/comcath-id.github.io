...
$auth_users = array(
    'admin' => '$2y$10$Dhd8lmcnxugHgXgBxMzwTesYo32dc/LYSeWT0LXV/NXLj6ty2Ls46', //admin@123
    'user' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO', //12
    'member' => '$2y$10$JCJPv9wABXRd86YdKcWQbuTicfIqiBNGGYdhejhQS5qFBRNWjXUV2' //wikt
);
...
$directories_users = array(
    'user' => $_SERVER['DOCUMENT_ROOT'].'/pub', 
    'member' => $_SERVER['DOCUMENT_ROOT'].'/pub');
                        ...
                        <div class="card fat">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="brand">
<img src="https://upload.wikimedia.org/wikipedia/commons/0/01/AnimatedStop2.gif" alt="Flowers in Chania">
                                    </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> TF<?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="#" target="_blank" class="float-right text-muted">TF<?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="#" target="_blank" class="float-right text-muted">TF <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
function fm_get_text_exts()
{
    return array(
        ...
        'map', 'lock', 'dtd', 'svg', 'scss', 'asp', 'aspx', 'asx', 'asmx', 'ashx', 'jsx', 'jsp', 'jspx', 'cfm', 'cgi', 'docx', 'pptx', 'pdf', 'xlsx'
    );
}
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'TF<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with TF">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'TFA';      $tr['en']['AppTitle']           = 'File Manager';
